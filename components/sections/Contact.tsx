    ...
    >
      ...
      <div className="max-w-5xl mx-auto px-6 md:px-12 relative z-10 w-full text-center">
        ...
        <div className="relative mb-12">
          <h2 ref={textRef1} className="font-display text-5xl md:text-8xl lg:text-[8rem] font-black tracking-tighter leading-none text-white" style={{ textShadow: "0 0 40px rgba(255,255,255,0.2)" }}>
            LET&apos;S
          </h2>
          <h2 ref={textRef2} className="font-display text-5xl md:text-8xl lg:text-[8rem] font-black tracking-tighter leading-none text-transparent" style={{ WebkitTextStroke: "2px var(--accent-red)", filter: "drop-shadow(0 0 20px rgba(225,6,0,0.5))" }}>
            RACE
          </h2>
        </div>

        <div ref={contentRef}>
          <p className="text-lg md:text-xl text-white/60 max-w-2xl mx-auto leading-relaxed font-light mb-16">
          ...
          <div className="mb-20">
            ...
            >
              ...
              <div className="relative flex items-center justify-center font-display text-2xl md:text-4xl font-black tracking-widest px-12 py-6 bg-black border border-white/10 text-white overflow-hidden" style={{ textShadow: "0 0 20px rgba(255,255,255,0.5)" }}>
          ...
          <div className="flex justify-center gap-4">
            {socialLinks.map((social) => (
              <a
                ...
                className="group relative px-6 py-3 overflow-hidden border border-white/5 bg-white/[0.02] backdrop-blur-sm"
              >
